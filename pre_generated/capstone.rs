...
pub type va_list = __builtin_va_list ; pub type __int8_t = :: std :: os :: raw :: c_schar ; pub type __uint8_t = :: std :: os :: raw :: c_uchar ; pub type __int16_t = :: std :: os :: raw :: c_short ; pub type __uint16_t = :: std :: os :: raw :: c_ushort ; pub type __int32_t = :: std :: os :: raw :: c_int ; pub type __uint32_t = :: std :: os :: raw :: c_uint ; pub type __int64_t = :: std :: os :: raw :: c_long ; pub type __uint64_t = :: std :: os :: raw :: c_ulong ; pub type csh = usize ; # [ repr ( u32 ) ] 
 /// Architecture type 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum cs_arch { 
 ...
 CS_ARCH_EVM = 11 , CS_ARCH_MAX = 12 , CS_ARCH_ALL = 65535 , } 
...
/// ///< used on M68HC12/HCS12 
 ...
 pub const CS_MODE_M680X_HCS08 : cs_mode = cs_mode ( 1024 ) ; impl :: std :: ops :: BitOr < cs_mode > for cs_mode { type Output = Self ; # [ inline ] fn bitor ( self , other : Self ) -> Self { cs_mode ( self . 0 | other . 0 ) } } impl :: std :: ops :: BitOrAssign for cs_mode { # [ inline ] fn bitor_assign ( & mut self , rhs : cs_mode ) { self . 0 |= rhs . 0 ; } } impl :: std :: ops :: BitAnd < cs_mode > for cs_mode { type Output = Self ; # [ inline ] fn bitand ( self , other : Self ) -> Self { cs_mode ( self . 0 & other . 0 ) } } impl :: std :: ops :: BitAndAssign for cs_mode { # [ inline ] fn bitand_assign ( & mut self , rhs : cs_mode ) { self . 0 &= rhs . 0 ; } } # [ repr ( C ) ] 
 /// Mode type 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub struct cs_mode ( pub i32 ) ; pub type cs_malloc_t = :: std :: option :: Option < unsafe extern "C" fn ( size : usize ) -> * mut :: std :: os :: raw :: c_void > ; pub type cs_calloc_t = :: std :: option :: Option < unsafe extern "C" fn ( nmemb : usize , size : usize ) -> * mut :: std :: os :: raw :: c_void > ; pub type cs_realloc_t = :: std :: option :: Option < unsafe extern "C" fn ( ptr : * mut :: std :: os :: raw :: c_void , size : usize ) -> * mut :: std :: os :: raw :: c_void > ; pub type cs_free_t = :: std :: option :: Option < unsafe extern "C" fn ( ptr : * mut :: std :: os :: raw :: c_void ) > ; pub type cs_vsnprintf_t = :: std :: option :: Option < unsafe extern "C" fn ( str : * mut :: std :: os :: raw :: c_char , size : usize , format : * const :: std :: os :: raw :: c_char , ap : * mut __va_list_tag ) -> :: std :: os :: raw :: c_int > ; 
 /// User-defined dynamic memory related functions: malloc/calloc/realloc/free/vsnprintf()
/// By default, Capstone uses system's malloc(), calloc(), realloc(), free() & vsnprintf(). 
 # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct cs_opt_mem { pub malloc : cs_malloc_t , pub calloc : cs_calloc_t , pub realloc : cs_realloc_t , pub free : cs_free_t , pub vsnprintf : cs_vsnprintf_t , } impl Clone for cs_opt_mem { fn clone ( & self ) -> Self { * self } } 
...
/// for @mnemonic. 
 # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct cs_opt_mnem { 
 /// ID of instruction to be customized. 
 pub id : :: std :: os :: raw :: c_uint , 
 /// Customized instruction mnemonic. 
 pub mnemonic : * const :: std :: os :: raw :: c_char , } impl Clone for cs_opt_mnem { fn clone ( & self ) -> Self { * self } } # [ repr ( u32 ) ] 
 /// Runtime option for the disassembled engine 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum cs_opt_type { 
 /// < No option specified 
 CS_OPT_INVALID = 0 , 
 ...
 CS_OPT_UNSIGNED = 8 , } pub mod cs_opt_value { 
 ...
 pub const CS_OPT_SYNTAX_MASM : Type = 4 ; } # [ repr ( u32 ) ] 
 /// Common instruction operand types - to be consistent across all architectures. 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum cs_op_type { 
...
/// It is possible to combine access types, for example: CS_AC_READ | CS_AC_WRITE 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum cs_ac_type { 
 /// < Uninitialized/invalid access type. 
 CS_AC_INVALID = 0 , 
 /// < Operand read from memory or register. 
 CS_AC_READ = 1 , 
 /// < Operand write to memory or register. 
 CS_AC_WRITE = 2 , } pub mod cs_group_type { 
...
/// @return: return number of bytes to skip, or 0 to immediately stop disassembling. 
 pub type cs_skipdata_cb_t = :: std :: option :: Option < unsafe extern "C" fn ( code : * const u8 , code_size : usize , offset : usize , user_data : * mut :: std :: os :: raw :: c_void ) -> usize > ; 
 /// User-customized setup for SKIPDATA option 
 # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct cs_opt_skipdata { 
 ...
 pub user_data : * mut :: std :: os :: raw :: c_void , } impl Clone for cs_opt_skipdata { fn clone ( & self ) -> Self { * self } } # [ repr ( u32 ) ] 
 /// ARM shift type 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum arm_shifter { ARM_SFT_INVALID = 0 , 
 ...
 ARM_SFT_ROR_REG = 9 , 
 /// < shift with register 
 ARM_SFT_RRX_REG = 10 , } # [ repr ( u32 ) ] 
 /// ARM condition code 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum arm_cc { ARM_CC_INVALID = 0 , 
 /// < Equal                      Equal 
 ARM_CC_EQ = 1 , 
 ...
 ARM_CC_AL = 15 , } # [ repr ( u32 ) ] # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum arm_sysreg { 
 ...
 /// Special registers for MSR 
 ARM_SYSREG_SPSR_HYP = 314 , } # [ repr ( u32 ) ] 
...
/// the option field for Memory Barrier operations. 
 ...
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum arm_op_type { 
...
/// This is associated with ARM_OP_MEM operand type above 
 ...
 pub lshift : :: std :: os :: raw :: c_int , } impl Clone for arm_op_mem { fn clone ( & self ) -> Self { * self } } 
 /// Instruction operand 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_arm_op { 
 /// < Vector Index for some vector operands (or -1 if irrelevant) 
 pub vector_index : :: std :: os :: raw :: c_int , pub shift : cs_arm_op__bindgen_ty_1 , 
 /// < operand type 
 pub type_ : arm_op_type , pub __bindgen_anon_1 : cs_arm_op__bindgen_ty_2 , 
 ...
 pub neon_lane : i8 , } # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct cs_arm_op__bindgen_ty_1 { pub type_ : arm_shifter , pub value : :: std :: os :: raw :: c_uint , } impl Clone for cs_arm_op__bindgen_ty_1 { fn clone ( & self ) -> Self { * self } } # [ repr ( C ) ] # [ derive ( Copy ) ] pub union cs_arm_op__bindgen_ty_2 { 
 ...
 pub setend : arm_setend_type , _bindgen_union_align : [ u64 ; 3usize ] , } impl Clone for cs_arm_op__bindgen_ty_2 { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_arm_op__bindgen_ty_2 { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_arm_op__bindgen_ty_2 {{ union }}" ) } } impl Clone for cs_arm_op { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_arm_op { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_arm_op {{ vector_index: {:?}, shift: {:?}, type: {:?}, __bindgen_anon_1: {:?}, subtracted: {:?}, access: {:?}, neon_lane: {:?} }}" , self . vector_index , self . shift , self . type_ , self . __bindgen_anon_1 , self . subtracted , self . access , self . neon_lane ) } } 
 /// Instruction structure 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_arm { 
 ...
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum arm64_pstate { ARM64_PSTATE_INVALID = 0 , ARM64_PSTATE_SPSEL = 5 , ARM64_PSTATE_DAIFSET = 30 , ARM64_PSTATE_DAIFCLR = 31 , } # [ repr ( u32 ) ] 
 /// Vector arrangement specifier (for FloatingPoint/Advanced SIMD insn) 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum arm64_vas { ARM64_VAS_INVALID = 0 , ARM64_VAS_8B = 1 , ARM64_VAS_16B = 2 , ARM64_VAS_4H = 3 , ARM64_VAS_8H = 4 , ARM64_VAS_2S = 5 , ARM64_VAS_4S = 6 , ARM64_VAS_1D = 7 , ARM64_VAS_2D = 8 , ARM64_VAS_1Q = 9 , } # [ repr ( u32 ) ] 
 /// Vector element size specifier 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum arm64_vess { ARM64_VESS_INVALID = 0 , ARM64_VESS_B = 1 , ARM64_VESS_H = 2 , ARM64_VESS_S = 3 , ARM64_VESS_D = 4 , } # [ repr ( u32 ) ] 
 ...
 /// Operand type for instruction's operands 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum arm64_op_type { 
 /// < = CS_OP_INVALID (Uninitialized). 
 ARM64_OP_INVALID = 0 , 
 /// < = CS_OP_REG (Register operand). 
 ARM64_OP_REG = 1 , 
...
/// This is associated with ARM64_OP_MEM operand type above 
 ...
 pub barrier : arm64_barrier_op , _bindgen_union_align : [ u64 ; 2usize ] , } impl Clone for cs_arm64_op__bindgen_ty_2 { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_arm64_op__bindgen_ty_2 { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_arm64_op__bindgen_ty_2 {{ union }}" ) } } impl Clone for cs_arm64_op { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_arm64_op { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_arm64_op {{ vector_index: {:?}, vas: {:?}, vess: {:?}, shift: {:?}, ext: {:?}, type: {:?}, __bindgen_anon_1: {:?}, access: {:?} }}" , self . vector_index , self . vas , self . vess , self . shift , self . ext , self . type_ , self . __bindgen_anon_1 , self . access ) } } 
 /// Instruction structure 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_arm64 { 
 /// < conditional code for this insn 
 pub cc : arm64_cc , 
 /// < does this insn update flags? 
 pub update_flags : bool , 
 ...
 M68K_AM_BRANCH_DISPLACEMENT = 19 , } # [ repr ( u32 ) ] 
 /// Operand type for instruction's operands 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum m68k_op_type { 
 /// < = CS_OP_INVALID (Uninitialized). 
 M68K_OP_INVALID = 0 , 
 /// < = CS_OP_REG (Register operand). 
 M68K_OP_REG = 1 , 
...
/// This is associated with M68K_OP_MEM operand type above 
 # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct m68k_op_mem { 
 ...
 pub offset : u8 , 
 /// < 0 = w, 1 = l 
 pub index_size : u8 , } impl Clone for m68k_op_mem { fn clone ( & self ) -> Self { * self } } # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct m68k_op_br_disp { 
 /// < displacement value 
 pub disp : i32 , 
 /// < Size from m68k_op_br_disp_size type above 
 pub disp_size : u8 , } impl Clone for m68k_op_br_disp { fn clone ( & self ) -> Self { * self } } 
 /// Instruction operand 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_m68k_op { pub __bindgen_anon_1 : cs_m68k_op__bindgen_ty_1 , 
 ...
 pub register_bits : u32 , pub type_ : m68k_op_type , 
 /// < M68K addressing mode for this op 
 pub address_mode : m68k_address_mode , } # [ repr ( C ) ] # [ derive ( Copy ) ] pub union cs_m68k_op__bindgen_ty_1 { 
 ...
 pub simm : f32 , 
 /// < register value for REG operand 
 pub reg : m68k_reg , pub reg_pair : cs_m68k_op__bindgen_ty_1__bindgen_ty_1 , _bindgen_union_align : u64 , } # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct cs_m68k_op__bindgen_ty_1__bindgen_ty_1 { pub reg_0 : m68k_reg , pub reg_1 : m68k_reg , } impl Clone for cs_m68k_op__bindgen_ty_1__bindgen_ty_1 { fn clone ( & self ) -> Self { * self } } impl Clone for cs_m68k_op__bindgen_ty_1 { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_m68k_op__bindgen_ty_1 { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_m68k_op__bindgen_ty_1 {{ union }}" ) } } impl Clone for cs_m68k_op { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_m68k_op { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_m68k_op {{ __bindgen_anon_1: {:?}, mem: {:?}, br_disp: {:?}, register_bits: {:?}, type: {:?}, address_mode: {:?} }}" , self . __bindgen_anon_1 , self . mem , self . br_disp , self . register_bits , self . type_ , self . address_mode ) } } # [ repr ( u32 ) ] 
 /// Operation size of the CPU instructions 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum m68k_cpu_size { 
 ...
 M68K_FPU_SIZE_EXTENDED = 12 , } # [ repr ( u32 ) ] 
 /// Type of size that is being used for the current instruction 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum m68k_size_type { M68K_SIZE_TYPE_INVALID = 0 , M68K_SIZE_TYPE_CPU = 1 , M68K_SIZE_TYPE_FPU = 2 , } 
 /// Operation size of the current instruction (NOT the actually size of instruction) 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct m68k_op_size { pub type_ : m68k_size_type , pub __bindgen_anon_1 : m68k_op_size__bindgen_ty_1 , } # [ repr ( C ) ] # [ derive ( Copy ) ] pub union m68k_op_size__bindgen_ty_1 { pub cpu_size : m68k_cpu_size , pub fpu_size : m68k_fpu_size , _bindgen_union_align : u32 , } impl Clone for m68k_op_size__bindgen_ty_1 { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for m68k_op_size__bindgen_ty_1 { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "m68k_op_size__bindgen_ty_1 {{ union }}" ) } } impl Clone for m68k_op_size { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for m68k_op_size { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "m68k_op_size {{ type: {:?}, __bindgen_anon_1: {:?} }}" , self . type_ , self . __bindgen_anon_1 ) } } 
 /// The M68K instruction and it's operands 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_m68k { 
 /// < operands for this instruction. 
 ...
 pub op_count : u8 , } impl Clone for cs_m68k { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_m68k { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_m68k {{ operands: {:?}, op_size: {:?}, op_count: {:?} }}" , self . operands , self . op_size , self . op_count ) } } # [ repr ( u32 ) ] 
 /// Operand type for instruction's operands 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum mips_op_type { 
 /// < = CS_OP_INVALID (Uninitialized). 
 MIPS_OP_INVALID = 0 , 
 /// < = CS_OP_REG (Register operand). 
 MIPS_OP_REG = 1 , 
...
/// This is associated with MIPS_OP_MEM operand type above 
 ...
 PPC_OP_CRX = 64 , } pub mod ppc_reg { 
 /// PPC registers 
 pub type Type = u32 ; pub const PPC_REG_INVALID : Type = 0 ; pub const PPC_REG_CARRY : Type = 1 ; pub const PPC_REG_CR0 : Type = 2 ; pub const PPC_REG_CR1 : Type = 3 ; pub const PPC_REG_CR2 : Type = 4 ; pub const PPC_REG_CR3 : Type = 5 ; pub const PPC_REG_CR4 : Type = 6 ; pub const PPC_REG_CR5 : Type = 7 ; pub const PPC_REG_CR6 : Type = 8 ; pub const PPC_REG_CR7 : Type = 9 ; pub const PPC_REG_CTR : Type = 10 ; pub const PPC_REG_F0 : Type = 11 ; pub const PPC_REG_F1 : Type = 12 ; pub const PPC_REG_F2 : Type = 13 ; pub const PPC_REG_F3 : Type = 14 ; pub const PPC_REG_F4 : Type = 15 ; pub const PPC_REG_F5 : Type = 16 ; pub const PPC_REG_F6 : Type = 17 ; pub const PPC_REG_F7 : Type = 18 ; pub const PPC_REG_F8 : Type = 19 ; pub const PPC_REG_F9 : Type = 20 ; pub const PPC_REG_F10 : Type = 21 ; pub const PPC_REG_F11 : Type = 22 ; pub const PPC_REG_F12 : Type = 23 ; pub const PPC_REG_F13 : Type = 24 ; pub const PPC_REG_F14 : Type = 25 ; pub const PPC_REG_F15 : Type = 26 ; pub const PPC_REG_F16 : Type = 27 ; pub const PPC_REG_F17 : Type = 28 ; pub const PPC_REG_F18 : Type = 29 ; pub const PPC_REG_F19 : Type = 30 ; pub const PPC_REG_F20 : Type = 31 ; pub const PPC_REG_F21 : Type = 32 ; pub const PPC_REG_F22 : Type = 33 ; pub const PPC_REG_F23 : Type = 34 ; pub const PPC_REG_F24 : Type = 35 ; pub const PPC_REG_F25 : Type = 36 ; pub const PPC_REG_F26 : Type = 37 ; pub const PPC_REG_F27 : Type = 38 ; pub const PPC_REG_F28 : Type = 39 ; pub const PPC_REG_F29 : Type = 40 ; pub const PPC_REG_F30 : Type = 41 ; pub const PPC_REG_F31 : Type = 42 ; pub const PPC_REG_LR : Type = 43 ; pub const PPC_REG_R0 : Type = 44 ; pub const PPC_REG_R1 : Type = 45 ; pub const PPC_REG_R2 : Type = 46 ; pub const PPC_REG_R3 : Type = 47 ; pub const PPC_REG_R4 : Type = 48 ; pub const PPC_REG_R5 : Type = 49 ; pub const PPC_REG_R6 : Type = 50 ; pub const PPC_REG_R7 : Type = 51 ; pub const PPC_REG_R8 : Type = 52 ; pub const PPC_REG_R9 : Type = 53 ; pub const PPC_REG_R10 : Type = 54 ; pub const PPC_REG_R11 : Type = 55 ; pub const PPC_REG_R12 : Type = 56 ; pub const PPC_REG_R13 : Type = 57 ; pub const PPC_REG_R14 : Type = 58 ; pub const PPC_REG_R15 : Type = 59 ; pub const PPC_REG_R16 : Type = 60 ; pub const PPC_REG_R17 : Type = 61 ; pub const PPC_REG_R18 : Type = 62 ; pub const PPC_REG_R19 : Type = 63 ; pub const PPC_REG_R20 : Type = 64 ; pub const PPC_REG_R21 : Type = 65 ; pub const PPC_REG_R22 : Type = 66 ; pub const PPC_REG_R23 : Type = 67 ; pub const PPC_REG_R24 : Type = 68 ; pub const PPC_REG_R25 : Type = 69 ; pub const PPC_REG_R26 : Type = 70 ; pub const PPC_REG_R27 : Type = 71 ; pub const PPC_REG_R28 : Type = 72 ; pub const PPC_REG_R29 : Type = 73 ; pub const PPC_REG_R30 : Type = 74 ; pub const PPC_REG_R31 : Type = 75 ; pub const PPC_REG_V0 : Type = 76 ; pub const PPC_REG_V1 : Type = 77 ; pub const PPC_REG_V2 : Type = 78 ; pub const PPC_REG_V3 : Type = 79 ; pub const PPC_REG_V4 : Type = 80 ; pub const PPC_REG_V5 : Type = 81 ; pub const PPC_REG_V6 : Type = 82 ; pub const PPC_REG_V7 : Type = 83 ; pub const PPC_REG_V8 : Type = 84 ; pub const PPC_REG_V9 : Type = 85 ; pub const PPC_REG_V10 : Type = 86 ; pub const PPC_REG_V11 : Type = 87 ; pub const PPC_REG_V12 : Type = 88 ; pub const PPC_REG_V13 : Type = 89 ; pub const PPC_REG_V14 : Type = 90 ; pub const PPC_REG_V15 : Type = 91 ; pub const PPC_REG_V16 : Type = 92 ; pub const PPC_REG_V17 : Type = 93 ; pub const PPC_REG_V18 : Type = 94 ; pub const PPC_REG_V19 : Type = 95 ; pub const PPC_REG_V20 : Type = 96 ; pub const PPC_REG_V21 : Type = 97 ; pub const PPC_REG_V22 : Type = 98 ; pub const PPC_REG_V23 : Type = 99 ; pub const PPC_REG_V24 : Type = 100 ; pub const PPC_REG_V25 : Type = 101 ; pub const PPC_REG_V26 : Type = 102 ; pub const PPC_REG_V27 : Type = 103 ; pub const PPC_REG_V28 : Type = 104 ; pub const PPC_REG_V29 : Type = 105 ; pub const PPC_REG_V30 : Type = 106 ; pub const PPC_REG_V31 : Type = 107 ; pub const PPC_REG_VRSAVE : Type = 108 ; pub const PPC_REG_VS0 : Type = 109 ; pub const PPC_REG_VS1 : Type = 110 ; pub const PPC_REG_VS2 : Type = 111 ; pub const PPC_REG_VS3 : Type = 112 ; pub const PPC_REG_VS4 : Type = 113 ; pub const PPC_REG_VS5 : Type = 114 ; pub const PPC_REG_VS6 : Type = 115 ; pub const PPC_REG_VS7 : Type = 116 ; pub const PPC_REG_VS8 : Type = 117 ; pub const PPC_REG_VS9 : Type = 118 ; pub const PPC_REG_VS10 : Type = 119 ; pub const PPC_REG_VS11 : Type = 120 ; pub const PPC_REG_VS12 : Type = 121 ; pub const PPC_REG_VS13 : Type = 122 ; pub const PPC_REG_VS14 : Type = 123 ; pub const PPC_REG_VS15 : Type = 124 ; pub const PPC_REG_VS16 : Type = 125 ; pub const PPC_REG_VS17 : Type = 126 ; pub const PPC_REG_VS18 : Type = 127 ; pub const PPC_REG_VS19 : Type = 128 ; pub const PPC_REG_VS20 : Type = 129 ; pub const PPC_REG_VS21 : Type = 130 ; pub const PPC_REG_VS22 : Type = 131 ; pub const PPC_REG_VS23 : Type = 132 ; pub const PPC_REG_VS24 : Type = 133 ; pub const PPC_REG_VS25 : Type = 134 ; pub const PPC_REG_VS26 : Type = 135 ; pub const PPC_REG_VS27 : Type = 136 ; pub const PPC_REG_VS28 : Type = 137 ; pub const PPC_REG_VS29 : Type = 138 ; pub const PPC_REG_VS30 : Type = 139 ; pub const PPC_REG_VS31 : Type = 140 ; pub const PPC_REG_VS32 : Type = 141 ; pub const PPC_REG_VS33 : Type = 142 ; pub const PPC_REG_VS34 : Type = 143 ; pub const PPC_REG_VS35 : Type = 144 ; pub const PPC_REG_VS36 : Type = 145 ; pub const PPC_REG_VS37 : Type = 146 ; pub const PPC_REG_VS38 : Type = 147 ; pub const PPC_REG_VS39 : Type = 148 ; pub const PPC_REG_VS40 : Type = 149 ; pub const PPC_REG_VS41 : Type = 150 ; pub const PPC_REG_VS42 : Type = 151 ; pub const PPC_REG_VS43 : Type = 152 ; pub const PPC_REG_VS44 : Type = 153 ; pub const PPC_REG_VS45 : Type = 154 ; pub const PPC_REG_VS46 : Type = 155 ; pub const PPC_REG_VS47 : Type = 156 ; pub const PPC_REG_VS48 : Type = 157 ; pub const PPC_REG_VS49 : Type = 158 ; pub const PPC_REG_VS50 : Type = 159 ; pub const PPC_REG_VS51 : Type = 160 ; pub const PPC_REG_VS52 : Type = 161 ; pub const PPC_REG_VS53 : Type = 162 ; pub const PPC_REG_VS54 : Type = 163 ; pub const PPC_REG_VS55 : Type = 164 ; pub const PPC_REG_VS56 : Type = 165 ; pub const PPC_REG_VS57 : Type = 166 ; pub const PPC_REG_VS58 : Type = 167 ; pub const PPC_REG_VS59 : Type = 168 ; pub const PPC_REG_VS60 : Type = 169 ; pub const PPC_REG_VS61 : Type = 170 ; pub const PPC_REG_VS62 : Type = 171 ; pub const PPC_REG_VS63 : Type = 172 ; pub const PPC_REG_Q0 : Type = 173 ; pub const PPC_REG_Q1 : Type = 174 ; pub const PPC_REG_Q2 : Type = 175 ; pub const PPC_REG_Q3 : Type = 176 ; pub const PPC_REG_Q4 : Type = 177 ; pub const PPC_REG_Q5 : Type = 178 ; pub const PPC_REG_Q6 : Type = 179 ; pub const PPC_REG_Q7 : Type = 180 ; pub const PPC_REG_Q8 : Type = 181 ; pub const PPC_REG_Q9 : Type = 182 ; pub const PPC_REG_Q10 : Type = 183 ; pub const PPC_REG_Q11 : Type = 184 ; pub const PPC_REG_Q12 : Type = 185 ; pub const PPC_REG_Q13 : Type = 186 ; pub const PPC_REG_Q14 : Type = 187 ; pub const PPC_REG_Q15 : Type = 188 ; pub const PPC_REG_Q16 : Type = 189 ; pub const PPC_REG_Q17 : Type = 190 ; pub const PPC_REG_Q18 : Type = 191 ; pub const PPC_REG_Q19 : Type = 192 ; pub const PPC_REG_Q20 : Type = 193 ; pub const PPC_REG_Q21 : Type = 194 ; pub const PPC_REG_Q22 : Type = 195 ; pub const PPC_REG_Q23 : Type = 196 ; pub const PPC_REG_Q24 : Type = 197 ; pub const PPC_REG_Q25 : Type = 198 ; pub const PPC_REG_Q26 : Type = 199 ; pub const PPC_REG_Q27 : Type = 200 ; pub const PPC_REG_Q28 : Type = 201 ; pub const PPC_REG_Q29 : Type = 202 ; pub const PPC_REG_Q30 : Type = 203 ; pub const PPC_REG_Q31 : Type = 204 ; pub const PPC_REG_RM : Type = 205 ; pub const PPC_REG_CTR8 : Type = 206 ; pub const PPC_REG_LR8 : Type = 207 ; pub const PPC_REG_CR1EQ : Type = 208 ; pub const PPC_REG_X2 : Type = 209 ; pub const PPC_REG_ENDING : Type = 210 ; } 
 /// Instruction's operand referring to memory
/// This is associated with PPC_OP_MEM operand type above 
 # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct ppc_op_mem { 
 /// < base register 
 pub base : ppc_reg::Type , 
 /// < displacement/offset value 
 pub disp : i32 , } impl Clone for ppc_op_mem { fn clone ( & self ) -> Self { * self } } # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct ppc_op_crx { pub scale : :: std :: os :: raw :: c_uint , pub reg : ppc_reg::Type , pub cond : ppc_bc , } impl Clone for ppc_op_crx { fn clone ( & self ) -> Self { * self } } 
 /// Instruction operand 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_ppc_op { 
 /// < operand type 
 pub type_ : ppc_op_type , pub __bindgen_anon_1 : cs_ppc_op__bindgen_ty_1 , } # [ repr ( C ) ] # [ derive ( Copy ) ] pub union cs_ppc_op__bindgen_ty_1 { 
 /// < register value for REG operand 
 ...
 pub crx : ppc_op_crx , _bindgen_union_align : [ u64 ; 2usize ] , } impl Clone for cs_ppc_op__bindgen_ty_1 { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_ppc_op__bindgen_ty_1 { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_ppc_op__bindgen_ty_1 {{ union }}" ) } } impl Clone for cs_ppc_op { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_ppc_op { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_ppc_op {{ type: {:?}, __bindgen_anon_1: {:?} }}" , self . type_ , self . __bindgen_anon_1 ) } } 
 /// Instruction structure 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_ppc { 
 ...
 /// < Ordered 
 SPARC_CC_FCC_O = 287 , } # [ repr ( u32 ) ] 
 /// Branch hint 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum sparc_hint { 
 /// < no hint 
 ...
 SPARC_HINT_PT = 2 , 
 /// < branch NOT taken 
 SPARC_HINT_PN = 4 , } # [ repr ( u32 ) ] 
 /// Operand type for instruction's operands 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum sparc_op_type { 
 /// < = CS_OP_INVALID (Uninitialized). 
 SPARC_OP_INVALID = 0 , 
 /// < = CS_OP_REG (Register operand). 
 SPARC_OP_REG = 1 , 
...
/// This is associated with SPARC_OP_MEM operand type above 
 ...
 pub index : u8 , 
 /// < displacement/offset value 
 pub disp : i32 , } impl Clone for sparc_op_mem { fn clone ( & self ) -> Self { * self } } 
 /// Instruction operand 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_sparc_op { 
 /// < operand type 
 pub type_ : sparc_op_type , pub __bindgen_anon_1 : cs_sparc_op__bindgen_ty_1 , } # [ repr ( C ) ] # [ derive ( Copy ) ] pub union cs_sparc_op__bindgen_ty_1 { 
 /// < register value for REG operand 
 pub reg : sparc_reg::Type , 
 /// < immediate value for IMM operand 
 pub imm : i64 , 
 /// < base/disp value for MEM operand 
 pub mem : sparc_op_mem , _bindgen_union_align : u64 , } impl Clone for cs_sparc_op__bindgen_ty_1 { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_sparc_op__bindgen_ty_1 { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_sparc_op__bindgen_ty_1 {{ union }}" ) } } impl Clone for cs_sparc_op { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_sparc_op { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_sparc_op {{ type: {:?}, __bindgen_anon_1: {:?} }}" , self . type_ , self . __bindgen_anon_1 ) } } 
 /// Instruction structure 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_sparc { 
...
/// This is associated with SYSZ_OP_MEM operand type above 
 ...
 pub length : u64 , 
 /// < displacement/offset value 
 pub disp : i64 , } impl Clone for sysz_op_mem { fn clone ( & self ) -> Self { * self } } 
 /// Instruction operand 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_sysz_op { 
 /// < operand type 
 pub type_ : sysz_op_type , pub __bindgen_anon_1 : cs_sysz_op__bindgen_ty_1 , } # [ repr ( C ) ] # [ derive ( Copy ) ] pub union cs_sysz_op__bindgen_ty_1 { 
 /// < register value for REG operand 
 pub reg : sysz_reg::Type , 
 /// < immediate value for IMM operand 
 pub imm : i64 , 
 /// < base/disp value for MEM operand 
 pub mem : sysz_op_mem , _bindgen_union_align : [ u64 ; 3usize ] , } impl Clone for cs_sysz_op__bindgen_ty_1 { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_sysz_op__bindgen_ty_1 { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_sysz_op__bindgen_ty_1 {{ union }}" ) } } impl Clone for cs_sysz_op { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_sysz_op { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_sysz_op {{ type: {:?}, __bindgen_anon_1: {:?} }}" , self . type_ , self . __bindgen_anon_1 ) } } # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_sysz { 
 /// < Code condition 
 pub cc : sysz_cc , 
 /// Number of operands of this instruction,
    /// /// or 0 when instruction has no operand. 
 ...
 X86_OP_IMM = 2 , 
 /// < = CS_OP_MEM (Memory operand). 
 X86_OP_MEM = 3 , } # [ repr ( u32 ) ] 
 /// XOP Code Condition type 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum x86_xop_cc { 
 /// < Uninitialized. 
 X86_XOP_CC_INVALID = 0 , X86_XOP_CC_LT = 1 , X86_XOP_CC_LE = 2 , X86_XOP_CC_GT = 3 , X86_XOP_CC_GE = 4 , X86_XOP_CC_EQ = 5 , X86_XOP_CC_NEQ = 6 , X86_XOP_CC_FALSE = 7 , X86_XOP_CC_TRUE = 8 , } # [ repr ( u32 ) ] 
 /// AVX broadcast type 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum x86_avx_bcast { 
 /// < Uninitialized. 
 ...
 X86_AVX_BCAST_16 = 4 , } # [ repr ( u32 ) ] 
 /// SSE Code Condition type 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum x86_sse_cc { 
 /// < Uninitialized. 
 X86_SSE_CC_INVALID = 0 , X86_SSE_CC_EQ = 1 , X86_SSE_CC_LT = 2 , X86_SSE_CC_LE = 3 , X86_SSE_CC_UNORD = 4 , X86_SSE_CC_NEQ = 5 , X86_SSE_CC_NLT = 6 , X86_SSE_CC_NLE = 7 , X86_SSE_CC_ORD = 8 , } # [ repr ( u32 ) ] 
 /// AVX Code Condition type 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum x86_avx_cc { 
 /// < Uninitialized. 
 X86_AVX_CC_INVALID = 0 , X86_AVX_CC_EQ = 1 , X86_AVX_CC_LT = 2 , X86_AVX_CC_LE = 3 , X86_AVX_CC_UNORD = 4 , X86_AVX_CC_NEQ = 5 , X86_AVX_CC_NLT = 6 , X86_AVX_CC_NLE = 7 , X86_AVX_CC_ORD = 8 , X86_AVX_CC_EQ_UQ = 9 , X86_AVX_CC_NGE = 10 , X86_AVX_CC_NGT = 11 , X86_AVX_CC_FALSE = 12 , X86_AVX_CC_NEQ_OQ = 13 , X86_AVX_CC_GE = 14 , X86_AVX_CC_GT = 15 , X86_AVX_CC_TRUE = 16 , X86_AVX_CC_EQ_OS = 17 , X86_AVX_CC_LT_OQ = 18 , X86_AVX_CC_LE_OQ = 19 , X86_AVX_CC_UNORD_S = 20 , X86_AVX_CC_NEQ_US = 21 , X86_AVX_CC_NLT_UQ = 22 , X86_AVX_CC_NLE_UQ = 23 , X86_AVX_CC_ORD_S = 24 , X86_AVX_CC_EQ_US = 25 , X86_AVX_CC_NGE_UQ = 26 , X86_AVX_CC_NGT_UQ = 27 , X86_AVX_CC_FALSE_OS = 28 , X86_AVX_CC_NEQ_OS = 29 , X86_AVX_CC_GE_OQ = 30 , X86_AVX_CC_GT_OQ = 31 , X86_AVX_CC_TRUE_US = 32 , } # [ repr ( u32 ) ] 
 /// AVX static rounding mode type 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum x86_avx_rm { 
 /// < Uninitialized. 
 ...
 X86_AVX_RM_RU = 3 , 
 /// < Round toward zero 
 X86_AVX_RM_RZ = 4 , } pub const X86_PREFIX_REPE : x86_prefix = x86_prefix :: X86_PREFIX_REP ; # [ repr ( u32 ) ] 
 /// Instruction prefixes - to be used in cs_x86.prefix[] 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum x86_prefix { 
...
/// This is associated with X86_OP_MEM operand type above 
 # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct x86_op_mem { 
 ...
 pub scale : :: std :: os :: raw :: c_int , 
 /// < displacement value 
 pub disp : i64 , } impl Clone for x86_op_mem { fn clone ( & self ) -> Self { * self } } 
 /// Instruction operand 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_x86_op { 
 /// < operand type 
 pub type_ : x86_op_type , pub __bindgen_anon_1 : cs_x86_op__bindgen_ty_1 , 
 ...
 /// AVX zero opmask {z} 
 pub avx_zero_opmask : bool , } # [ repr ( C ) ] # [ derive ( Copy ) ] pub union cs_x86_op__bindgen_ty_1 { 
 /// < register value for REG operand 
 pub reg : x86_reg::Type , 
 /// < immediate value for IMM operand 
 pub imm : i64 , 
 /// < base/index/scale/disp value for MEM operand 
 pub mem : x86_op_mem , _bindgen_union_align : [ u64 ; 3usize ] , } impl Clone for cs_x86_op__bindgen_ty_1 { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_x86_op__bindgen_ty_1 { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_x86_op__bindgen_ty_1 {{ union }}" ) } } impl Clone for cs_x86_op { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_x86_op { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_x86_op {{ type: {:?}, __bindgen_anon_1: {:?}, size: {:?}, access: {:?}, avx_bcast: {:?}, avx_zero_opmask: {:?} }}" , self . type_ , self . __bindgen_anon_1 , self . size , self . access , self . avx_bcast , self . avx_zero_opmask ) } } # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct cs_x86_encoding { 
 /// ModR/M offset, or 0 when irrelevant 
 pub modrm_offset : u8 , 
 /// Displacement offset, or 0 when irrelevant. 
 pub disp_offset : u8 , pub disp_size : u8 , 
 /// Immediate offset, or 0 when irrelevant. 
 pub imm_offset : u8 , pub imm_size : u8 , } impl Clone for cs_x86_encoding { fn clone ( & self ) -> Self { * self } } 
 /// Instruction structure 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_x86 { 
 ...
 pub avx_rm : x86_avx_rm , pub __bindgen_anon_1 : cs_x86__bindgen_ty_1 , 
 /// Number of operands of this instruction,
    /// /// or 0 when instruction has no operand. 
 pub op_count : u8 , 
 /// < operands for this instruction. 
 ...
 pub encoding : cs_x86_encoding , } # [ repr ( C ) ] # [ derive ( Copy ) ] pub union cs_x86__bindgen_ty_1 { 
 ...
 XCORE_OP_IMM = 2 , 
 /// < = CS_OP_MEM (Memory operand). 
 XCORE_OP_MEM = 3 , } pub mod xcore_reg { 
 /// XCore registers 
 pub type Type = u32 ; pub const XCORE_REG_INVALID : Type = 0 ; pub const XCORE_REG_CP : Type = 1 ; pub const XCORE_REG_DP : Type = 2 ; pub const XCORE_REG_LR : Type = 3 ; pub const XCORE_REG_SP : Type = 4 ; pub const XCORE_REG_R0 : Type = 5 ; pub const XCORE_REG_R1 : Type = 6 ; pub const XCORE_REG_R2 : Type = 7 ; pub const XCORE_REG_R3 : Type = 8 ; pub const XCORE_REG_R4 : Type = 9 ; pub const XCORE_REG_R5 : Type = 10 ; pub const XCORE_REG_R6 : Type = 11 ; pub const XCORE_REG_R7 : Type = 12 ; pub const XCORE_REG_R8 : Type = 13 ; pub const XCORE_REG_R9 : Type = 14 ; pub const XCORE_REG_R10 : Type = 15 ; pub const XCORE_REG_R11 : Type = 16 ; 
 /// < pc 
 pub const XCORE_REG_PC : Type = 17 ; 
 /// < save pc 
 pub const XCORE_REG_SCP : Type = 18 ; pub const XCORE_REG_SSR : Type = 19 ; pub const XCORE_REG_ET : Type = 20 ; pub const XCORE_REG_ED : Type = 21 ; pub const XCORE_REG_SED : Type = 22 ; pub const XCORE_REG_KEP : Type = 23 ; pub const XCORE_REG_KSP : Type = 24 ; pub const XCORE_REG_ID : Type = 25 ; pub const XCORE_REG_ENDING : Type = 26 ; } 
 /// Instruction's operand referring to memory
/// This is associated with XCORE_OP_MEM operand type above 
 # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct xcore_op_mem { 
 /// < base register, can be safely interpreted as
 ...
 TMS320C64X_OP_REGPAIR = 64 , } # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct tms320c64x_op_mem { 
 /// < base register 
 ...
 /// < modification 
 pub modify : :: std :: os :: raw :: c_uint , } impl Clone for tms320c64x_op_mem { fn clone ( & self ) -> Self { * self } } # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_tms320c64x_op { 
 /// < operand type 
 pub type_ : tms320c64x_op_type , pub __bindgen_anon_1 : cs_tms320c64x_op__bindgen_ty_1 , } # [ repr ( C ) ] # [ derive ( Copy ) ] pub union cs_tms320c64x_op__bindgen_ty_1 { 
 /// < register value for REG operand or first register for REGPAIR operand 
 pub reg : :: std :: os :: raw :: c_uint , 
 /// < immediate value for IMM operand 
 pub imm : i32 , 
 /// < base/disp value for MEM operand 
 pub mem : tms320c64x_op_mem , _bindgen_union_align : [ u32 ; 7usize ] , } impl Clone for cs_tms320c64x_op__bindgen_ty_1 { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_tms320c64x_op__bindgen_ty_1 { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_tms320c64x_op__bindgen_ty_1 {{ union }}" ) } } impl Clone for cs_tms320c64x_op { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_tms320c64x_op { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_tms320c64x_op {{ type: {:?}, __bindgen_anon_1: {:?} }}" , self . type_ , self . __bindgen_anon_1 ) } } # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_tms320c64x { pub op_count : u8 , 
 /// < operands for this instruction. 
 pub operands : [ cs_tms320c64x_op ; 8usize ] , pub condition : cs_tms320c64x__bindgen_ty_1 , pub funit : cs_tms320c64x__bindgen_ty_2 , pub parallel : :: std :: os :: raw :: c_uint , } # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct cs_tms320c64x__bindgen_ty_1 { pub reg : :: std :: os :: raw :: c_uint , pub zero : :: std :: os :: raw :: c_uint , } impl Clone for cs_tms320c64x__bindgen_ty_1 { fn clone ( & self ) -> Self { * self } } # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct cs_tms320c64x__bindgen_ty_2 { pub unit : :: std :: os :: raw :: c_uint , pub side : :: std :: os :: raw :: c_uint , pub crosspath : :: std :: os :: raw :: c_uint , } impl Clone for cs_tms320c64x__bindgen_ty_2 { fn clone ( & self ) -> Self { * self } } impl Clone for cs_tms320c64x { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_tms320c64x { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_tms320c64x {{ op_count: {:?}, operands: {:?}, condition: {:?}, funit: {:?}, parallel: {:?} }}" , self . op_count , self . operands , self . condition , self . funit , self . parallel ) } } # [ repr ( u32 ) ] 
 /// M680X registers and special registers 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum m680x_reg { M680X_REG_INVALID = 0 , 
 ...
 M680X_REG_ENDING = 22 , } # [ repr ( u32 ) ] 
 /// Operand type for instruction's operands 
 # [ derive ( Debug , Copy , Clone , PartialEq , Eq , Hash ) ] pub enum m680x_op_type { 
 /// < = CS_OP_INVALID (Uninitialized). 
 M680X_OP_INVALID = 0 , 
 /// < = Register operand. 
 M680X_OP_REGISTER = 1 , 
 ...
 # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct m680x_op_idx { 
 ...
 pub flags : u8 , } impl Clone for m680x_op_idx { fn clone ( & self ) -> Self { * self } } 
 /// Instruction's memory operand referring to relative addressing (Bcc/LBcc) 
 # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct m680x_op_rel { 
 /// < The absolute address.
    /// ///< calculated as PC + offset. PC is the first
    /// ///< address after the instruction. 
 pub address : u16 , 
 /// < the offset/displacement value 
 pub offset : i16 , } impl Clone for m680x_op_rel { fn clone ( & self ) -> Self { * self } } 
 /// Instruction's operand referring to extended addressing 
 # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct m680x_op_ext { 
 /// < The absolute address 
 pub address : u16 , 
 /// < true if extended indirect addressing 
 pub indirect : bool , } impl Clone for m680x_op_ext { fn clone ( & self ) -> Self { * self } } 
 /// Instruction operand 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_m680x_op { pub type_ : m680x_op_type , pub __bindgen_anon_1 : cs_m680x_op__bindgen_ty_1 , 
 /// < size of this operand (in bytes) 
 pub size : u8 , 
 /// How is this operand accessed? (READ, WRITE or READ|WRITE)
    /// /// This field is combined of cs_ac_type.
    /// /// NOTE: this field is irrelevant if engine is compiled in DIET 
 pub access : u8 , } # [ repr ( C ) ] # [ derive ( Copy ) ] pub union cs_m680x_op__bindgen_ty_1 { 
 /// < immediate value for IMM operand 
 pub imm : i32 , 
 /// < register value for REG operand 
 pub reg : m680x_reg , 
 ...
 pub const_val : u8 , _bindgen_union_align : [ u32 ; 4usize ] , } impl Clone for cs_m680x_op__bindgen_ty_1 { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_m680x_op__bindgen_ty_1 { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_m680x_op__bindgen_ty_1 {{ union }}" ) } } impl Clone for cs_m680x_op { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_m680x_op { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_m680x_op {{ type: {:?}, __bindgen_anon_1: {:?}, size: {:?}, access: {:?} }}" , self . type_ , self . __bindgen_anon_1 , self . size , self . access ) } } 
 /// The M680X instruction and it's operands 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_m680x { 
 /// < See: M680X instruction flags 
 pub flags : u8 , 
 /// < number of operands for the instruction or 0 
 pub op_count : u8 , 
 /// < operands for this insn. 
 pub operands : [ cs_m680x_op ; 9usize ] , } impl Clone for cs_m680x { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_m680x { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_m680x {{ flags: {:?}, op_count: {:?}, operands: {:?} }}" , self . flags , self . op_count , self . operands ) } } 
 /// Instruction structure 
 # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct cs_evm { 
 ...
 pub fee : :: std :: os :: raw :: c_uint , } impl Clone for cs_evm { fn clone ( & self ) -> Self { * self } } 
 /// NOTE: All information in cs_detail is only available when CS_OPT_DETAIL = CS_OPT_ON
/// Initialized as memset(., 0, offsetof(cs_detail, ARCH)+sizeof(cs_ARCH))
/// by ARCH_getInstruction in arch/ARCH/ARCHDisassembler.c
/// if cs_detail changes, in particular if a field is added after the union,
/// then update arch/ARCH/ARCHDisassembler.c accordingly 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_detail { 
 ...
 pub groups_count : u8 , pub __bindgen_anon_1 : cs_detail__bindgen_ty_1 , } 
 /// Architecture-specific instruction info 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub union cs_detail__bindgen_ty_1 { 
 ...
 pub m680x : cs_m680x , 
 /// < Ethereum architecture 
 pub evm : cs_evm , _bindgen_union_align : [ u64 ; 221usize ] , } impl Clone for cs_detail__bindgen_ty_1 { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_detail__bindgen_ty_1 { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_detail__bindgen_ty_1 {{ union }}" ) } } impl Clone for cs_detail { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_detail { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_detail {{ regs_read: {:?}, regs_read_count: {:?}, regs_write: {:?}, regs_write_count: {:?}, groups: {:?}, groups_count: {:?}, __bindgen_anon_1: {:?} }}" , self . regs_read , self . regs_read_count , self . regs_write , self . regs_write_count , self . groups , self . groups_count , self . __bindgen_anon_1 ) } } 
 /// Detail information of disassembled instruction 
 # [ repr ( C ) ] # [ derive ( Copy ) ] pub struct cs_insn { 
 ...
 pub detail : * mut cs_detail , } impl Clone for cs_insn { fn clone ( & self ) -> Self { * self } } impl :: std :: fmt :: Debug for cs_insn { fn fmt ( & self , f : & mut :: std :: fmt :: Formatter ) -> :: std :: fmt :: Result { write ! ( f , "cs_insn {{ id: {:?}, address: {:?}, size: {:?}, bytes: {:?}, mnemonic: [{}], op_str: [{}], detail: {:?} }}" , self . id , self . address , self . size , self . bytes , self . mnemonic . iter ( ) . enumerate ( ) . map ( | ( i , v ) | format ! ( "{}{:?}" , if i > 0 { ", " } else { "" } , v ) ) . collect :: < String > ( ) , self . op_str . iter ( ) . enumerate ( ) . map ( | ( i , v ) | format ! ( "{}{:?}" , if i > 0 { ", " } else { "" } , v ) ) . collect :: < String > ( ) , self . detail ) } } pub mod cs_err { 
...
/// These are values returned by cs_errno() 
 ...
 /// < X86 Intel syntax is unsupported (opt-out at compile time) 
 pub const CS_ERR_X86_MASM : Type = 14 ; } extern "C" { 
...
/// set both @major & @minor arguments to NULL. 
 pub fn cs_version ( major : * mut :: std :: os :: raw :: c_int , minor : * mut :: std :: os :: raw :: c_int ) -> :: std :: os :: raw :: c_uint ; } extern "C" { 
...
/// @return True if this library supports the given arch, or in 'diet' mode. 
 pub fn cs_support ( query : :: std :: os :: raw :: c_int ) -> bool ; } extern "C" { 
...
/// for detailed error). 
 pub fn cs_open ( arch : cs_arch , mode : cs_mode , handle : * mut csh ) -> cs_err::Type ; } extern "C" { 
...
/// @return CS_ERR_OK on success, or other value on failure (refer to cs_err enum
/// for detailed error). 
 pub fn cs_close ( handle : * mut csh ) -> cs_err::Type ; } extern "C" { 
...
/// even before cs_open() 
 pub fn cs_option ( handle : csh , type_ : cs_opt_type , value : usize ) -> cs_err::Type ; } extern "C" { 
...
/// @return: error code of cs_err enum type (CS_ERR_*, see above) 
 pub fn cs_errno ( handle : csh ) -> cs_err::Type ; } extern "C" { 
...
/// passed in the argument @code 
 pub fn cs_strerror ( code : cs_err::Type ) -> * const :: std :: os :: raw :: c_char ; } extern "C" { 
...
/// On failure, call cs_errno() for error code. 
 pub fn cs_disasm ( handle : csh , code : * const u8 , code_size : usize , address : u64 , count : usize , insn : * mut * mut cs_insn ) -> usize ; } extern "C" { 
 /// Deprecated function - to be retired in the next version!
/// Use cs_disasm() instead of cs_disasm_ex() 
 pub fn cs_disasm_ex ( handle : csh , code : * const u8 , code_size : usize , address : u64 , count : usize , insn : * mut * mut cs_insn ) -> usize ; } extern "C" { 
 /// Free memory allocated by cs_malloc() or cs_disasm() (argument @insn)
///
/// @insn: pointer returned by @insn argument in cs_disasm() or cs_malloc()
/// @count: number of cs_insn structures returned by cs_disasm(), or 1
/// to free memory allocated by cs_malloc(). 
 pub fn cs_free ( insn : * mut cs_insn , count : usize ) ; } extern "C" { 
...
/// this instruction with cs_free(insn, 1) 
 pub fn cs_malloc ( handle : csh ) -> * mut cs_insn ; } extern "C" { 
...
///
/// On failure, call cs_errno() for error code. 
 pub fn cs_disasm_iter ( handle : csh , code : * mut * const u8 , size : * mut usize , address : * mut u64 , insn : * mut cs_insn ) -> bool ; } extern "C" { 
...
/// @return: string name of the register, or NULL if @reg_id is invalid. 
 pub fn cs_reg_name ( handle : csh , reg_id : :: std :: os :: raw :: c_uint ) -> * const :: std :: os :: raw :: c_char ; } extern "C" { 
...
/// @return: string name of the instruction, or NULL if @insn_id is invalid. 
 pub fn cs_insn_name ( handle : csh , insn_id : :: std :: os :: raw :: c_uint ) -> * const :: std :: os :: raw :: c_char ; } extern "C" { 
...
/// @return: string name of the group, or NULL if @group_id is invalid. 
 pub fn cs_group_name ( handle : csh , group_id : :: std :: os :: raw :: c_uint ) -> * const :: std :: os :: raw :: c_char ; } extern "C" { 
...
/// @return: true if this instruction indeed belongs to the given group, or false otherwise. 
 pub fn cs_insn_group ( handle : csh , insn : * const cs_insn , group_id : :: std :: os :: raw :: c_uint ) -> bool ; } extern "C" { 
...
/// @return: true if this instruction indeed implicitly used the given register, or false otherwise. 
 pub fn cs_reg_read ( handle : csh , insn : * const cs_insn , reg_id : :: std :: os :: raw :: c_uint ) -> bool ; } extern "C" { 
...
/// @return: true if this instruction indeed implicitly modified the given register, or false otherwise. 
 pub fn cs_reg_write ( handle : csh , insn : * const cs_insn , reg_id : :: std :: os :: raw :: c_uint ) -> bool ; } extern "C" { 
...
/// or -1 on failure. 
 pub fn cs_op_count ( handle : csh , insn : * const cs_insn , op_type : :: std :: os :: raw :: c_uint ) -> :: std :: os :: raw :: c_int ; } extern "C" { 
...
/// in instruction @insn, or -1 on failure. 
 pub fn cs_op_index ( handle : csh , insn : * const cs_insn , op_type : :: std :: os :: raw :: c_uint , position : :: std :: os :: raw :: c_uint ) -> :: std :: os :: raw :: c_int ; } 
 /// Type of array to keep the list of registers 
 pub type cs_regs = [ u16 ; 64usize ] ; extern "C" { 
...
/// @return CS_ERR_OK on success, or other value on failure (refer to cs_err enum
/// for detailed error). 
 pub fn cs_regs_access ( handle : csh , insn : * const cs_insn , regs_read : * mut u16 , regs_read_count : * mut u8 , regs_write : * mut u16 , regs_write_count : * mut u8 ) -> cs_err::Type ; } pub type __builtin_va_list = [ __va_list_tag ; 1usize ] ; # [ repr ( C ) ] # [ derive ( Debug , Copy ) ] pub struct __va_list_tag { pub gp_offset : :: std :: os :: raw :: c_uint , pub fp_offset : :: std :: os :: raw :: c_uint , pub overflow_arg_area : * mut :: std :: os :: raw :: c_void , pub reg_save_area : * mut :: std :: os :: raw :: c_void , } impl Clone for __va_list_tag { fn clone ( & self ) -> Self { * self } }