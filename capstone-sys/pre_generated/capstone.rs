...
pub enum mos65xx_address_mode {
    ...
    MOS65XX_AM_ZP = 4,
    #[doc = "< 8 Bit immediate value"]
    MOS65XX_AM_IMM = 5,
    #[doc = "< indexed absolute addressing by the X index register"]
    MOS65XX_AM_ABSX = 6,
    #[doc = "< indexed absolute addressing by the Y index register"]
    MOS65XX_AM_ABSY = 7,
    #[doc = "< indexed indirect addressing by the X index register"]
    MOS65XX_AM_INDX = 8,
    #[doc = "< indirect indexed addressing by the Y index register"]
    MOS65XX_AM_INDY = 9,
